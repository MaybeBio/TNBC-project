...
# Settings
主要是这里的allenrichment的tsv文件的来源
```{r settings}
# 10kb, for one panel
dir_data <- "/mnt/disk4/haitao/bysj_seu/geo_data/hic/script7/mustache_result/TNBC_preprocessing_any/Motif_Enrichment"

fileNameIn1 <- "/mnt/disk4/haitao/bysj_seu/geo_data/hic/script7/allEnrichments.tsv"
fileNameOut1 <- file.path(dir_data, "Unibind_enrichment_beeswarmplot.pdf")
# Min number of supporting peaks，以下3个参数都要修改
min_peaks <- 50
# Top TFs
top_TFs <- 5
...
mtx_summary <- mtx_summary %>% dplyr::filter(Count >= min_exp)
